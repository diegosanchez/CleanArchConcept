 ...
 */
public class DiscountRestClient implements EntityGateway<Discount, CouponId> {
    @Override
    public Discount find(CouponId couponId) {
        ...
        return new Discount( discountFromApi );
    }
}
